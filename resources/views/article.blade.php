                    ...
                    <div class="article-rte">
                        ...
                        <div class="article-meta">
                            ...
                            <div class="article-card-published text_14 d-flex align-items-center">
                                ...
                                <a href="{{ route('article') }}" class="article-date d-none d-sm-flex align-items-center">
                                            <span class="icon-tag">
                        ...
                        <div class="next-prev-article mt-5 d-flex align-items-center justify-content-between">
                            <a href="{{ route('article') }}" class="article-btn prev-article-btn mt-2">PREV ARTICLE</a>
                            <a href="{{ route('article') }}" class="article-btn next-article-btn active mt-2">NEXT ARTICLE</a>
                        </div>
                    ...
                    <div class="filter-drawer blog-sidebar">
                            ...
                            <div class="accordion-collapse">
                                <ul class="filter-lists list-unstyled mb-0">
                                    <li class="filter-item">
                                        <a class="filter-label" href="{{ route('collection') }}">
                                            <input type="checkbox" />
                        ...
                        <div class="filter-widget">
                            ...
                            <div class="filter-related">
                                <div class="related-item related-item-article d-flex">
                                    ...
                                    <div class="related-product-info">
                                        <h2 class="related-heading text_14">
                                            <a href="{{ route('article') }}">Modern furniture in velvet</a>
                                        </h2>
                                ...
                                <div class="related-item related-item-article d-flex">
                                    ...
                                    <div class="related-product-info">
                                        <h2 class="related-heading text_14">
                                            <a href="{{ route('article') }}">Ultimate luxury furniture</a>
                                        </h2>
                                        <p class="article-card-published text_12 d-flex align-items-center mt-2">
                                                    <span class="article-date d-flex align-items-center">
                                                        <span class="icon-publish">
                                ...
                                <div class="related-item related-item-article d-flex">
                                    ...
                                    <div class="related-product-info">
                                        <h2 class="related-heading text_14">
                                            <a href="{{ route('article') }}">Small bedroom look bigger</a>
                                        </h2>
                                        <p class="article-card-published text_12 d-flex align-items-center mt-2">
                                                    <span class="article-date d-flex align-items-center">
                                                        <span class="icon-publish">
                                ...
                                <div class="related-item related-item-article d-flex">
                                    ...
                                    <div class="related-product-info">
                                        <h2 class="related-heading text_14">
                                            <a href="{{ route('article') }}">Update your living room</a>
                                        </h2>
                                        <p class="article-card-published text_12 d-flex align-items-center mt-2">
                                                    <span class="article-date d-flex align-items-center">
                                                        <span class="icon-publish">
                                ...
                                <div class="related-item related-item-article d-flex">
                                    ...
                                    <div class="related-product-info">
                                        <h2 class="related-heading text_14">
                                            <a href="{{ route('article') }}">Choose the right fabric</a>
                                        </h2>
                                        <p class="article-card-published text_12 d-flex align-items-center mt-2">
                                                    <span class="article-date d-flex align-items-center">
                                                        <span class="icon-publish">
                        ...
                        <div class="filter-widget">
                            ...
                            <ul class="filter-tags list-unstyled">
                                ...
                                <li class="tag-item"><a href="{{ route('collection') }}">Furniture</a></li>
